...
Public Class EstadisticaInfraccion

    Private Sub EstadisticaInfraccion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        GenerarChartEstadisticaInfraccion()
