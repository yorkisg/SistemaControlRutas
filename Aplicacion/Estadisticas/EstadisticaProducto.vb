...
Public Class EstadisticaProducto
    ...
    Private Sub EstadisticaProducto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        CargarEstadisticaHistorialProducto()

        'Se llama al metodo para que cargue el grafico
        GenerarChartEstadisticaProducto()
    ...
    Private Sub EstadisticaProducto_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
