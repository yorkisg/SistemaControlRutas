...
Public Class ListadoPersona
    ...
    Private Sub ListadoPersona_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ListadoPersona_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub BotonGuardar_Click(sender As Object, e As EventArgs) Handles BotonGuardar.Click
        ...
        If DataGridView.RowCount > 0 Then
            ...
            If MaestroPersona.Visible = True Then
                'si el formulario "MaestroChofer" esta activo, se carga la informacion seleccionada del datagridview

                MaestroPersona.TextBox1.Text = DataGridView.Rows(DataGridView.CurrentRow.Index).Cells(0).Value
                MaestroPersona.TextBox2.Text = DataGridView.Rows(DataGridView.CurrentRow.Index).Cells(1).Value
                MaestroPersona.TextBox3.Text = DataGridView.Rows(DataGridView.CurrentRow.Index).Cells(2).Value
                MaestroPersona.TextBox4.Text = DataGridView.Rows(DataGridView.CurrentRow.Index).Cells(3).Value
                MaestroPersona.ComboDescripcion.Text = DataGridView.Rows(DataGridView.CurrentRow.Index).Cells(4).Value
    ...
    Function Filtrar(ByVal busqueda As String) As DataTable
        ...
        Dim cmd As New MySqlCommand("SELECT idpersona, nombrepersona, telefono1, telefono2, descripcion FROM personal WHERE nombrepersona LIKE '%" & busqueda & "%' ", cnn)
