...
Public Class MaestroEstado
    ...
    Private Sub MaestroEstado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub MaestroEstado_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub MaestroEstado_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles MyBase.KeyDown
