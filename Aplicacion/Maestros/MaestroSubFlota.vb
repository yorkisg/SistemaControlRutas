...
Public Class MaestroSubFlota
    ...
    Private Sub MaestroSubFlota_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ComboFlota.SelectedIndex = 0
        ComboTipo.SelectedIndex = 0

    End Sub

    Private Sub MaestroFlota_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub MaestroFlota_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles MyBase.KeyDown
