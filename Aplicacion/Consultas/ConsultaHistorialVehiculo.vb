...
Public Class ConsultaHistorialVehiculo

    Private Sub ConsultaHistorialVehiculo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If DateTimePicker1.Value <= DateTimePicker2.Value Then
                ...
                If TextBox1.Text <> "" Then
                    ...
                    CargarGridHistorialVehiculo()

                ElseIf TextBox1.Text = "" Then

                    CargarGridHistorialVehiculoGeneral()
