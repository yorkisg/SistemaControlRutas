...
Public Class ConsultaVehiculo
    ...
    Private Sub ConsultaVehiculo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If DateTimePicker1.Value <= DateTimePicker2.Value Then
                ...
                If TextBox1.Text = "" Then
                    ...
                    MsgBox("Debe seleccionar un vehiculo.", MsgBoxStyle.Exclamation, "Error.")
